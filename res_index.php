...
*/
//include 'quotes.php';
$tmp = new template("res_index.html");

$script = '<script language="javascript" src="jquery-1.8.3.min.js"></script>
			  <script type="text/javascript" src="res_index.js"></script>
			  <script type="text/javascript" src="res_main.js"></script>
			  <link rel="stylesheet" type="text/css" href="res_main.css">
			  <link rel="stylesheet" type="text/css" href="res_index.css">
			  ';
